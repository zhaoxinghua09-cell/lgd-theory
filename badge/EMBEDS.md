...
```markdown
[![LGD-aligned](https://img.shields.io/badge/LGD--aligned-%E5%8F%82%E7%85%A7-14B8A6)](https://github.com/zhaoxinghua09-cell/lgd-theory)
```
...
> This work is LGD-aligned (Lifecycle Governance Doctrine, DOI: 10.5281/zenodo.22456647).
> 本文参照《全程治理论》（有籍·有证·有门禁）设计治理。

## 5. 公众号 / 微信生态

- SVG 微信不支持上传，用 PNG：`badge/png/lgd-shield-color-128.png`（文末配图）或 `lgd-lockup-color.png`（横版）
- 图注模板：`LGD-aligned · 参照全程治理论设计`，阅读原文链接指向 GitHub 仓库
