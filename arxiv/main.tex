...
\title{\textbf{The Lifecycle Governance Doctrine (LGD):\\ Registry, Evidence, and Gates Across the Full Life of AI and Devices}}
\author{Xinghua Zhao (Steven Zhao)\thanks{ORCID: 0009-0001-0512-1237. Independent research initiative. Contact details are provided in the submission metadata. This work is released under CC BY 4.0 as part of the \texttt{lgd-theory} open repository.}}
