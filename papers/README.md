...
| [P5-governance-impossibility-map-v0.2-zh.md](P5-governance-impossibility-map-v0.2-zh.md) | P5 地图 | v0.2（2026-09-08） | 五块不可能域（哲学/可解释性/判定/责任/授权-观测）整合图 + 可能域定位；英文版备稿中 |
